...
/**
 * Script to copy Nuxt.js build output to the public/admin directory
 */
...
const destDir = path.resolve(__dirname, '../../../public/admin');
...
// Copy the Nuxt build to the public/admin directory
try {
